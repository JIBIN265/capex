sap.ui.define(
    ...
    function (PageController) {
        ...
        return PageController.extend('capex.ext.view.ViewPdfPage', {
            /**
            ...
            handleFullScreen: function (oEvent) {
                ...
                this.byId("capex::attachmentsViewPdfPagePage--enterFullScreenBtn").setVisible(false)
                this.byId("capex::attachmentsViewPdfPagePage--exitFullScreenBtn").setVisible(true)

            },

            handleExitFullScreen: function (oEvent) {
                this.editFlow.getInternalRouting().switchFullScreen()
                this.byId("capex::attachmentsViewPdfPagePage--enterFullScreenBtn").setVisible(true)
                this.byId("capex::attachmentsViewPdfPagePage--exitFullScreenBtn").setVisible(false)
            },
